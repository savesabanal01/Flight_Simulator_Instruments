...
ThreeSFlightSimsI2C::ThreeSFlightSimsI2C(uint8_t addrI2C)
{
    _addrI2C = addrI2C;
    _initialised = true;
}

void ThreeSFlightSimsI2C::begin()
{
    Wire.begin();
    Wire.setClock(400000);
}

void ThreeSFlightSimsI2C::attach()
{
}

void ThreeSFlightSimsI2C::detach()
{
    if (!_initialised)
        return;
    _initialised = false;
...
void ThreeSFlightSimsI2C::set(int16_t messageID, char *payload)
{
    /* **********************************************************************************
...
void ThreeSFlightSimsI2C::update()
{
